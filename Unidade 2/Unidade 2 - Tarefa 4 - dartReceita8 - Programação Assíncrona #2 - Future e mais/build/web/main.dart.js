...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  var desafio$322 = Object.create(dart.library);
  ...
  var T$ = {
    ...
    BuildContextAndListAndWidgetNToWidget: () => (T$.BuildContextAndListAndWidgetNToWidget = dart.constFn(dart.fnType(framework.Widget, [framework.BuildContext, core.List, T$.WidgetN()])))(),
    ...
    JSArrayOfDropdownMenuItemOfint: () => (T$.JSArrayOfDropdownMenuItemOfint = dart.constFn(_interceptors.JSArray$(T$.DropdownMenuItemOfint())))(),
    ...
    MapEntryOfint$StringToDataColumn: () => (T$.MapEntryOfint$StringToDataColumn = dart.constFn(dart.fnType(data_table.DataColumn, [T$.MapEntryOfint$String()])))(),
  ...
  dart.defineLazy(CT, {
    get C0() {
      return C[0] = dart.fn(desafio$322.main, T$.VoidTovoid());
    },
    get C1() {
    ...
    get C13() {
      return C[13] = dart.const({
        ...
        [BottomNavigationBarItem_tooltip]: null,
        [BottomNavigationBarItem_backgroundColor]: null,
        [BottomNavigationBarItem_label]: "Usuário",
    ...
    get C17() {
      return C[17] = dart.const({
        ...
        [Text_textSpan]: null,
        [Text_data]: "Bora colocar para rodar?"
      });
    },
    get C20() {
    ...
    get C21() {
      return C[21] = dart.const({
        ...
        [Text_locale]: null,
        [Text_textDirection]: null,
        [Text_textAlign]: C[22] || CT.C22,
        [Text_strutStyle]: null,
        [Text_style]: null,
        [Text_textSpan]: null,
        [Text_data]: "Toque em um dos botões abaixo para carregar os dados."
      });
    },
    get C23() {
  ...
  var I = [
    "file:///zapp/project/lib/desafio%202.dart",
  ...
  var tableStateNotifier = dart.privateName(desafio$322, "DataService.tableStateNotifier");
  var columnNamesNotifier = dart.privateName(desafio$322, "DataService.columnNamesNotifier");
  var selectedQuantity = dart.privateName(desafio$322, "DataService.selectedQuantity");
  desafio$322.DataService = class DataService extends core.Object {
    ...
    static ['_#new#tearOff']() {
      return new desafio$322.DataService.new();
    }
    carregar(index, context) {
      let quantidade = this.selectedQuantity.value;
      if (index === 0)
        this.carregarCafes(quantidade, context);
      else if (index === 1)
        this.carregarCervejas(quantidade, context);
      else if (index === 2)
        this.carregarNacoes(quantidade, context);
      else if (index === 3) this.carregarUsuarios(quantidade, context);
    }
    carregarDadosAsync(url, columnNames, context) {
      return async.async(dart.void, (function* carregarDadosAsync() {
        try {
          let uri = core.Uri.parse(url);
          let resposta = (yield http.get(uri));
          if (resposta.statusCode === 200) {
            let dadosJson = convert.jsonDecode(resposta.body);
            this.tableStateNotifier.value = core.List.as(dadosJson);
            this.columnNamesNotifier.value = columnNames;
            scaffold.ScaffoldMessenger.of(context).showSnackBar(new snack_bar.SnackBar.new({content: new text.Text.new("Dados carregados!")}));
          } else {
            scaffold.ScaffoldMessenger.of(context).showSnackBar(new snack_bar.SnackBar.new({content: new text.Text.new("Erro ao carregar dados")}));
          }
        } catch (e$) {
          let e = dart.getThrown(e$);
          if (core.Object.is(e)) {
            scaffold.ScaffoldMessenger.of(context).showSnackBar(new snack_bar.SnackBar.new({content: new text.Text.new("Erro: " + dart.str(e))}));
          } else
            throw e$;
        }
      }).bind(this));
    ...
    carregarNacoes(quantidade, context) {
      let columnNames = T$.JSArrayOfString().of(["id", "uid", "nationality", "language", "capital", "national_sport", "flag"]);
      this.carregarDadosAsync("https://random-data-api.com/api/nation/random_nation?size=" + dart.str(quantidade), columnNames, context);
    }
    carregarCafes(quantidade, context) {
      let columnNames = T$.JSArrayOfString().of(["id", "uid", "blend_name", "origin", "variety", "intensifier"]);
      this.carregarDadosAsync("https://random-data-api.com/api/coffee/random_coffee?size=" + dart.str(quantidade), columnNames, context);
    }
    carregarCervejas(quantidade, context) {
      let columnNames = T$.JSArrayOfString().of(["id", "uid", "brand", "name", "style", "blg"]);
      this.carregarDadosAsync("https://random-data-api.com/api/beer/random_beer?size=" + dart.str(quantidade), columnNames, context);
    }
    carregarUsuarios(quantidade, context) {
      let columnNames = T$.JSArrayOfString().of(["id", "uid", "first_name", "last_name", "email", "username"]);
      this.carregarDadosAsync("https://random-data-api.com/api/users/random_user?size=" + dart.str(quantidade), columnNames, context);
    }
  };
  (desafio$322.DataService.new = function() {
    ...
    this[selectedQuantity] = new (T$.ValueNotifierOfint()).new(5);
    ;
  }).prototype = desafio$322.DataService.prototype;
  dart.addTypeTests(desafio$322.DataService);
  dart.addTypeCaches(desafio$322.DataService);
  dart.setMethodSignature(desafio$322.DataService, () => ({
    __proto__: dart.getMethods(desafio$322.DataService.__proto__),
    carregar: dart.fnType(dart.void, [core.int, framework.BuildContext]),
    carregarDadosAsync: dart.fnType(dart.void, [core.String, core.List$(core.String), framework.BuildContext]),
    carregarNacoes: dart.fnType(dart.void, [core.int, framework.BuildContext]),
    carregarCafes: dart.fnType(dart.void, [core.int, framework.BuildContext]),
    carregarCervejas: dart.fnType(dart.void, [core.int, framework.BuildContext]),
    carregarUsuarios: dart.fnType(dart.void, [core.int, framework.BuildContext])
  }));
  dart.setLibraryUri(desafio$322.DataService, I[0]);
  dart.setFieldSignature(desafio$322.DataService, () => ({
    __proto__: dart.getFields(desafio$322.DataService.__proto__),
    ...
    selectedQuantity: dart.finalFieldType(change_notifier.ValueNotifier$(core.int))
  }));
  ...
  desafio$322.MyApp = class MyApp extends framework.StatelessWidget {
    build(context) {
      return new app.MaterialApp.new({theme: theme_data.ThemeData.new({primarySwatch: colors.Colors.blue}), debugShowCheckedModeBanner: false, home: new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: C[1] || CT.C1}), body: new basic.Center.new({child: new (T$.ValueListenableBuilderOfList()).new({valueListenable: desafio$322.dataService.tableStateNotifier, builder: dart.fn((_, value, __) => {
                if (value[$isNotEmpty]) {
                  let columnNames = desafio$322.dataService.columnNamesNotifier.value;
                  return new desafio$322.DataTableWidget.new({jsonObjects: value, columnNames: columnNames});
                } else {
                  return new desafio$322.WelcomeWidget.new();
                }
              }, T$.BuildContextAndListAndWidgetNToWidget())})}), bottomNavigationBar: new basic.Stack.new({children: T$.JSArrayOfWidget().of([new desafio$322.NewNavBar.new({itemSelectedCallback: dart.bind(desafio$322.dataService, 'carregar')}), new basic.Positioned.new({right: 0, bottom: 0, child: new basic.Padding.new({padding: C[2] || CT.C2, child: new (T$.ValueListenableBuilderOfint()).new({valueListenable: desafio$322.dataService.selectedQuantity, builder: dart.fn((_, value, __) => new (T$.DropdownButtonOfint()).new({value: value, items: T$.JSArrayOfDropdownMenuItemOfint().of([new (T$.DropdownMenuItemOfint()).new({child: new text.Text.new("5"), value: 5}), new (T$.DropdownMenuItemOfint()).new({child: new text.Text.new("10"), value: 10}), new (T$.DropdownMenuItemOfint()).new({child: new text.Text.new("15"), value: 15})]), onChanged: dart.fn(value => desafio$322.dataService.selectedQuantity.value = dart.nullCast(value, core.int), T$.intNTovoid())}), T$.BuildContextAndintAndWidgetNToDropdownButtonOfint())})})})])})})});
    }
    static ['_#new#tearOff']() {
      return new desafio$322.MyApp.new();
    }
  };
  (desafio$322.MyApp.new = function() {
    desafio$322.MyApp.__proto__.new.call(this);
    ;
  }).prototype = desafio$322.MyApp.prototype;
  dart.addTypeTests(desafio$322.MyApp);
  dart.addTypeCaches(desafio$322.MyApp);
  dart.setMethodSignature(desafio$322.MyApp, () => ({
    __proto__: dart.getMethods(desafio$322.MyApp.__proto__),
    build: dart.fnType(framework.Widget, [framework.BuildContext])
  }));
  dart.setLibraryUri(desafio$322.MyApp, I[0]);
  var itemSelectedCallback$ = dart.privateName(desafio$322, "NewNavBar.itemSelectedCallback");
  ...
  desafio$322.NewNavBar = class NewNavBar extends framework$.HookWidget {
    get itemSelectedCallback() {
      return this[itemSelectedCallback$];
    }
    set itemSelectedCallback(value) {
      super.itemSelectedCallback = value;
    }
    static ['_#new#tearOff'](opts) {
      let itemSelectedCallback = opts && 'itemSelectedCallback' in opts ? opts.itemSelectedCallback : null;
      return new desafio$322.NewNavBar.new({itemSelectedCallback: itemSelectedCallback});
    }
    build(context) {
      ...
      return new bottom_navigation_bar.BottomNavigationBar.new({onTap: dart.fn(index => {
          ...
          t1 = index;
          t2 = context;
          this.itemSelectedCallback(t1, t2);
        }, T$.intTovoid()), currentIndex: state.value, items: C[3] || CT.C3, backgroundColor: colors.Colors.grey._get(300), selectedItemColor: colors.Colors.black, unselectedItemColor: colors.Colors.red});
    }
  };
  (desafio$322.NewNavBar.new = function(opts) {
    let itemSelectedCallback = opts && 'itemSelectedCallback' in opts ? opts.itemSelectedCallback : null;
    this[itemSelectedCallback$] = itemSelectedCallback;
    desafio$322.NewNavBar.__proto__.new.call(this);
    ;
  }).prototype = desafio$322.NewNavBar.prototype;
  dart.addTypeTests(desafio$322.NewNavBar);
  dart.addTypeCaches(desafio$322.NewNavBar);
  dart.setMethodSignature(desafio$322.NewNavBar, () => ({
    __proto__: dart.getMethods(desafio$322.NewNavBar.__proto__),
    build: dart.fnType(framework.Widget, [framework.BuildContext])
  }));
  dart.setLibraryUri(desafio$322.NewNavBar, I[0]);
  dart.setFieldSignature(desafio$322.NewNavBar, () => ({
    __proto__: dart.getFields(desafio$322.NewNavBar.__proto__),
    itemSelectedCallback: dart.finalFieldType(dart.fnType(dart.dynamic, [core.int, framework.BuildContext]))
  }));
  var jsonObjects$ = dart.privateName(desafio$322, "DataTableWidget.jsonObjects");
  var columnNames$ = dart.privateName(desafio$322, "DataTableWidget.columnNames");
  desafio$322.DataTableWidget = class DataTableWidget extends framework.StatefulWidget {
    get jsonObjects() {
    ...
    static ['_#new#tearOff'](opts) {
      ...
      return new desafio$322.DataTableWidget.new({key: key, jsonObjects: jsonObjects, columnNames: columnNames});
    }
    createState() {
      return new desafio$322._DataTableWidgetState.new();
    }
  };
  (desafio$322.DataTableWidget.new = function(opts) {
    let key = opts && 'key' in opts ? opts.key : null;
    let jsonObjects = opts && 'jsonObjects' in opts ? opts.jsonObjects : null;
    let columnNames = opts && 'columnNames' in opts ? opts.columnNames : null;
    this[jsonObjects$] = jsonObjects;
    this[columnNames$] = columnNames;
    desafio$322.DataTableWidget.__proto__.new.call(this, {key: key});
    ;
  }).prototype = desafio$322.DataTableWidget.prototype;
  dart.addTypeTests(desafio$322.DataTableWidget);
  dart.addTypeCaches(desafio$322.DataTableWidget);
  dart.setMethodSignature(desafio$322.DataTableWidget, () => ({
    __proto__: dart.getMethods(desafio$322.DataTableWidget.__proto__),
    createState: dart.fnType(desafio$322._DataTableWidgetState, [])
  }));
  dart.setLibraryUri(desafio$322.DataTableWidget, I[0]);
  dart.setFieldSignature(desafio$322.DataTableWidget, () => ({
    __proto__: dart.getFields(desafio$322.DataTableWidget.__proto__),
    jsonObjects: dart.finalFieldType(core.List),
    columnNames: dart.finalFieldType(core.List$(core.String))
  }));
  desafio$322._DataTableWidgetState = class _DataTableWidgetState extends framework.State$(desafio$322.DataTableWidget) {
    initState() {
      super.initState();
      this.sortedList[$addAll](this.widget.jsonObjects);
    }
    getColumns() {
      return this.widget.columnNames[$asMap]()[$entries][$map](data_table.DataColumn, dart.fn(entry => {
        let columnName = entry.value;
        return new data_table.DataColumn.new({label: new text.Text.new(columnName), onSort: dart.fn((columnIndex, ascending) => {
            this.onColumnSort(columnIndex);
          }, T$.intAndboolTovoid()), tooltip: "Sort by " + columnName});
      }, T$.MapEntryOfint$StringToDataColumn()))[$toList]();
    }
    onColumnSort(columnIndex) {
      if (columnIndex === this.sortedColumnIndex) {
        this.setState(dart.fn(() => {
          this.isAscending = !this.isAscending;
          this.sortedList = this.sortedList[$reversed][$toList]();
        }, T$.VoidTovoid()));
      } else {
        this.setState(dart.fn(() => {
          this.sortedColumnIndex = columnIndex;
          this.isAscending = true;
          this.sortedList[$sort](dart.fn((a, b) => {
            let aValue = dart.dsend(a, '_get', [this.widget.columnNames[$_get](columnIndex)]);
            let bValue = dart.dsend(b, '_get', [this.widget.columnNames[$_get](columnIndex)]);
    ...
    build(context) {
      return new single_child_scroll_view.SingleChildScrollView.new({scrollDirection: basic_types.Axis.horizontal, child: new data_table.DataTable.new({columns: this.getColumns(), rows: this.sortedList[$map](data_table.DataRow, dart.fn(jsonObject => {
            let cells = this.widget.columnNames[$map](data_table.DataCell, dart.fn(columnName => {
              let value = dart.dsend(jsonObject, '_get', [columnName]);
              return new data_table.DataCell.new(new text.Text.new(dart.str(value)));
            }, T$.StringToDataCell()))[$toList]();
            return new data_table.DataRow.new({cells: cells});
  ...
  (desafio$322._DataTableWidgetState.new = function() {
    this.sortedList = [];
    this.sortedColumnIndex = -1;
    this.isAscending = true;
    desafio$322._DataTableWidgetState.__proto__.new.call(this);
    ;
  }).prototype = desafio$322._DataTableWidgetState.prototype;
  dart.addTypeTests(desafio$322._DataTableWidgetState);
  dart.addTypeCaches(desafio$322._DataTableWidgetState);
  dart.setMethodSignature(desafio$322._DataTableWidgetState, () => ({
    __proto__: dart.getMethods(desafio$322._DataTableWidgetState.__proto__),
    getColumns: dart.fnType(core.List$(data_table.DataColumn), []),
    onColumnSort: dart.fnType(dart.void, [core.int]),
    build: dart.fnType(framework.Widget, [framework.BuildContext])
  }));
  dart.setLibraryUri(desafio$322._DataTableWidgetState, I[0]);
  dart.setFieldSignature(desafio$322._DataTableWidgetState, () => ({
    __proto__: dart.getFields(desafio$322._DataTableWidgetState.__proto__),
    sortedList: dart.fieldType(core.List),
    sortedColumnIndex: dart.fieldType(core.int),
    isAscending: dart.fieldType(core.bool)
  }));
  ...
  desafio$322.WelcomeWidget = class WelcomeWidget extends framework.StatelessWidget {
    build(context) {
      return new basic.Column.new({mainAxisAlignment: flex.MainAxisAlignment.center, children: T$.JSArrayOfWidget().of([new image.Image.asset("assets/minha_imagem.jpg", {width: 200, height: 200}), C[16] || CT.C16, C[17] || CT.C17, C[20] || CT.C20, C[21] || CT.C21])});
    }
    static ['_#new#tearOff']() {
      return new desafio$322.WelcomeWidget.new();
    }
  };
  (desafio$322.WelcomeWidget.new = function() {
    desafio$322.WelcomeWidget.__proto__.new.call(this);
    ;
  }).prototype = desafio$322.WelcomeWidget.prototype;
  dart.addTypeTests(desafio$322.WelcomeWidget);
  dart.addTypeCaches(desafio$322.WelcomeWidget);
  dart.setMethodSignature(desafio$322.WelcomeWidget, () => ({
    __proto__: dart.getMethods(desafio$322.WelcomeWidget.__proto__),
    build: dart.fnType(framework.Widget, [framework.BuildContext])
  }));
  dart.setLibraryUri(desafio$322.WelcomeWidget, I[0]);
  desafio$322.main = function main$() {
    binding.runApp(new desafio$322.MyApp.new());
  };
  dart.defineLazy(desafio$322, {
    /*desafio$322.CAFES_TAB_INDEX*/get CAFES_TAB_INDEX() {
      return 0;
    },
    /*desafio$322.CERVEJAS_TAB_INDEX*/get CERVEJAS_TAB_INDEX() {
      return 1;
    },
    /*desafio$322.NACOES_TAB_INDEX*/get NACOES_TAB_INDEX() {
      return 2;
    },
    /*desafio$322.USUARIO_TAB_INDEX*/get USUARIO_TAB_INDEX() {
      return 3;
    },
    /*desafio$322.dataService*/get dataService() {
      return new desafio$322.DataService.new();
    }
  }, false);
  ...
  dart.trackLibraries("zapp_user_main", {
    ...
    "file:///zapp/project/lib/desafio%202.dart": desafio$322,
